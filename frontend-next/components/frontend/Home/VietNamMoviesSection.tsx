        ...
        <div className="vn-section relative w-full" style={{ padding: "clamp(18px,3vw,32px)", paddingBottom: "0px" }}>
            ...
            <div className="relative z-10 flex items-center justify-between mb-5">
                <div>
                    ...
                    <h2 style={{ fontFamily: "var(--font-primary)", fontSize: "clamp(1rem,3vw,1.7rem)", fontWeight: 700, color: "#fff", lineHeight: 1 }}>Phim Việt Nam Mới</h2>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link href="/loc-phim?country=viet-nam&type_list=phim-bo&page=1"
                                    ...
                                    <Link href={`/phim/${movie.slug}`} style={{ display: "block" }}>
                                        <div className="movie-card relative rounded-xl overflow-hidden" style={{ aspectRatio: "16/9" }}>
                                            <Image
                                                ...
                                                quality={70}
                                                className="vn-thumb object-cover"
                                            />
