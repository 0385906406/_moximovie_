...
const STYLES = `
  ...
  .cs-tab { transition: all 0.2s ease; font-family: var(--font-primary); font-size: 0.8rem; font-weight: 600; cursor: pointer; border: none; }
  ...
  .cs-input {
    ...
    color: #fff; font-family: var(--font-primary); font-size: 0.85rem;
  ...
  .cs-btn-primary {
    ...
    font-family: var(--font-primary); font-size: 0.82rem; font-weight: 800;
  ...
  .cs-btn-secondary {
    ...
    font-family: var(--font-primary); font-size: 0.82rem; font-weight: 600;
...
export default function ComicSearch() {
    ...
    const applyFilters = () => {
        ...
        if (mode === "keyword" && keyword.trim()) {
            ...
            router.push(`/doc-truyen?${qs.toString()}`);
            return;
        }
            ...
            <div className="mb-4 flex items-center gap-3">
                ...
                {(keyword || selectedCategory) && (
                    <span style={{
                        ...
                        fontFamily: "var(--font-primary)", fontSize: "0.68rem", fontWeight: 600,
                    }}>
            ...
            {filterVisible && (
                <div className="cs-filter-box space-y-4 rounded-xl p-5" style={{
                    ...
                    <div className="flex items-center gap-3 pb-1" style={{ borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                        ...
                        <span style={{
                            fontFamily: "var(--font-mono-sans)", fontSize: "1rem",
                    ...
                    {mode === "keyword" && (
                        <div>
                            <label style={{
                                ...
                                fontFamily: "var(--font-primary)", fontSize: "0.75rem",
