    ...
    <div className="cdp-chapter-panel rounded-2xl overflow-hidden mb-6"
        ...
        <div className="flex items-center justify-between px-5 py-4"
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    <p style={{ fontFamily: "var(--font-primary)", fontSize: "0.65rem", color: "rgba(255,255,255,0.4)", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase" }}>Đang đọc</p>
                    <h2 style={{ fontFamily: "var(--font-mono-sans)", fontSize: "1.15rem", color: "#fff", letterSpacing: "0.05em", lineHeight: 1.1 }}>
...
export default function ComicDetailPage() {
    ...
    if (!comic) return (
        <div className="flex flex-col items-center justify-center w-full h-[300px] text-gray-400">
            ...
            <p style={{ fontFamily: "var(--font-primary)", fontSize: "0.9rem" }}>Không tìm thấy truyện</p>
        </div>
    );
                                ...
                                <div className="flex items-center justify-between mb-4 px-1">
                                    <button
                                        ...
                                        style={{
                                            ...
                                            fontFamily: "var(--font-primary)", fontSize: "0.78rem", fontWeight: 700,
                                    ...
                                    <span style={{
                                        fontFamily: "var(--font-mono-sans)", fontSize: "0.95rem",
                    ...
                    <aside className="rounded-2xl overflow-hidden flex flex-col"
                        ...
                        <div className="px-5 py-4 flex-shrink-0" style={{ borderBottom: "1px solid rgba(16,185,129,0.08)" }}>
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <h2 style={{ fontFamily: "var(--font-mono-sans)", fontSize: "1.1rem", color: "#fff", letterSpacing: "0.06em" }}>
                                    Danh sách chương
                                </h2>
                                <span className="ml-auto rounded-full px-2.5 py-0.5"
                                    style={{ background: "rgba(16,185,129,0.12)", border: "1px solid rgba(16,185,129,0.25)", color: "#10b981", fontFamily: "var(--font-primary)", fontSize: "0.65rem", fontWeight: 700 }}>
                                    {chapters.length}
                                </span>
                            </div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    style={{
                                        ...
                                        fontFamily: "var(--font-primary)", fontSize: "0.78rem",
                        ...
                        <ul className="cdp-scroll overflow-y-auto flex-1 py-2 px-2">
                            {filtered.length === 0 && (
                                <li className="py-8 text-center" style={{ fontFamily: "var(--font-primary)", fontSize: "0.8rem", color: "rgba(255,255,255,0.3)" }}>
                                        ...
                                        >
                                            ...
                                            <span className="flex-shrink-0 w-7 h-7 rounded-lg flex items-center justify-center"
                                                style={{
                                                    ...
                                                    fontFamily: "var(--font-mono-sans)", fontSize: "0.78rem",
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p style={{
                                                    fontFamily: "var(--font-primary)", fontSize: "0.8rem", fontWeight: 600,
