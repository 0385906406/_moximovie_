...
function PhimHoatHinhPage() {
    ...
    const countryFromUrl = searchParams.get("country") || "nhat-ban";

    /* ── Fetch ── */
    const fetchMovies = useCallback(async (page: number, country: string) => {
        setLoading(true);
        try {
    ...
    useEffect(() => {
        fetchMovies(pageFromUrl, countryFromUrl);
    ...
    return (
        <div className="w-full mt-28 text-white">
            <SEO
                title="Phim Hoạt Hình | Xem Hoạt Hình Mới Nhất Vietsub HD | MoxiMovie"
                description="Xem phim hoạt hình mới nhất, Vietsub HD 1080p tại MoxiMovie. Kho phim hoạt hình phong phú, cập nhật nhanh, xem mượt mà, không quảng cáo độc hại."
                canonical="https://www.moximovie.click/hoat-hinh"
            />
                ...
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                    <div>
                        <div className="flex items-center gap-2.5 mb-2">
                            <div className="w-1 h-6 rounded-full bg-gradient-to-b from-orange-400 to-pink-600 shrink-0" />
...
export default function Page() {
    return <Suspense fallback={null}><PhimHoatHinhPage /></Suspense>;
}
