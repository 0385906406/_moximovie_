    ...
    return (
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-6 pr-3 py-2">
            ...
            <button
                ...
                className={`group inline-flex items-center gap-2 px-3 py-2 rounded-full text-sm ring-1 ring-white/10 bg-white/0 hover:bg-white/10 transition ${isFavorite ? "text-red-400" : "text-gray-200"
                    }`}
            >
            ...
            <div className="relative">
                <button
                    ...
                    className="group inline-flex items-center gap-2 px-3 py-2 rounded-full text-sm ring-1 ring-white/10 text-white bg-white/0 hover:bg-white/10 transition"
                >
                    <i className="fa-bookmark fa-regular text-white" />
                    <span>Lưu</span>
                </button>
