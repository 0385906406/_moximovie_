        ...
        <div className="as-root w-full px-3 sm:px-5 xl:px-6 pt-4 pb-10">
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                <Link to="/hoat-hinh"
                    ...
                    style={{ color: "rgba(255,255,255,0.4)", fontFamily: "'Outfit',sans-serif", fontSize: "0.78rem" }}
            ...
            <div
                ...
                style={{ height: "clamp(380px,52vw,660px)", borderRadius: "5.28px", background: "#06090a" }}
                    ...
                    <div style={{ maxWidth: "clamp(280px,54%,640px)", display: "flex", flexDirection: "column", gap: "clamp(8px,1.2vw,13px)" }}>
                        ...
                        <div className="as-s1 flex items-center gap-2 flex-wrap">
                            ...
                            <span style={{
                                ...
                                fontFamily: "'Outfit',sans-serif", fontSize: "0.6rem", fontWeight: 800,
                        ...
                        <div className="as-s5 flex items-center flex-wrap" style={{ gap: 10 }}>
                            ...
                            <Link to={`/phim/${slide.slug}`}>
                                ...
                                >
                                    <svg width="15" height="14" viewBox="0 0 24 22" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="absolute bottom-0 left-0 right-0 z-30">
                    <div ref={thumbsRef} className="as-strip flex justify-center overflow-x-auto px-4 pb-3 pt-2" style={{ gap: 6 }}>
                        {datas.map((item, i) => {
                            ...
                            return (
                                <MovieHoverPopup key={item._id ?? i} movie={item}>
                                    <div
